...
//   $("#clearFieldsBtn").click(function (t) { t.preventDefault, $("textarea").val(""), localStorage.clear() }), $(".time-div").each(function () { var t = $(this).attr("id").split("-")[1]; a == t ? ($(this).addClass("present"), $(this).children(".description").addClass("white-text")) : a < t ? ($(this).removeClass("present"), $(this).addClass("future")) : t < a && ($(this).removeClass("future"), $(this).addClass("past")) }),
